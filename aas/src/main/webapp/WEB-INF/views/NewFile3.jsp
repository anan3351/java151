...
<div class="container-fluid">
  <div class="row">
	<img alt="poster1" src="./images/logo.png" style="display:inline; height: auto; margin-left: 50px" >&nbsp;&nbsp;&nbsp;
	<span style="margin-left: 380px">
		<input type="text" class="centerBox" style="width: 400px"> <input type="button" value="검색">&nbsp;&nbsp;&nbsp;
	</span>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
	  <ul class="nav navbar-nav">
	    <li class="active"><a href="#">뮤지컬</a></li>
	    <li><a href="#">연극</a></li>
	    <li><a href="#">배우</a></li>
	    <li><a href="#">공연장</a></li>
	    <li><a href="#">공지사항</a></li>
...
<div class="container"">
	<div class="row content" style="text-align: center;">
		...
		<div> 
         ...
         <div>
         	<button><</button>
            <img alt="poster1" src="./images/p6.jpg" style="display:inline; width: 10%; height: auto;" >&nbsp;&nbsp;&nbsp;&nbsp;
            <img alt="poster1" src="./images/p7.jpg" style="display:inline; width: 10%; height: auto;" >&nbsp;&nbsp;&nbsp;&nbsp;
            <img alt="poster1" src="./images/p9.jpg" style="display:inline; width: 10%; height: auto;" >&nbsp;&nbsp;&nbsp;&nbsp;
            <img alt="poster1" src="./images/p1.jpg" style="display:inline; width: 10%; height: auto;" >&nbsp;&nbsp;&nbsp;&nbsp;
            <img alt="poster1" src="./images/p10.jpg" style="display:inline; width: 10%; height: auto;" >&nbsp;&nbsp;&nbsp;&nbsp;
            <img alt="poster1" src="./images/p11.jpg" style="display:inline; width: 10%; height: auto;" >
            <button>></button>  
         </div>
...
<footer class="container-fluid bg-4 text-center" style="position: relative; height: 100px; padding-bottom: 60px; overflow: hidden;">
    ...
    <div style="display: flex; justify-content: center; align-items: center; position: absolute; bottom: 10px; left: 50%; transform: translateX(-50%);">
        <img src="./images/s2.png" alt="f" style="height: 40px; margin: 0 5px;">
        <img src="./images/s3.png" alt="i" style="height: 35px; margin: 0 5px;">
        <img src="./images/s4.png" alt="t" style="height: 25px; margin: 0 5px;">
    </div>
    <div style="font-size: medium; position: absolute; right: 50px; top: 10px; text-align: right; padding-right: 150px;">
...
new Swiper('.swiper-container', {
	...
	autoplay: {
		delay: 3000, // 자동 슬라이드 시간 (밀리초 단위)
		disableOnInteraction: false, // 사용자가 슬라이드에 상호작용해도 자동 슬라이드가 멈추지 않음
	},

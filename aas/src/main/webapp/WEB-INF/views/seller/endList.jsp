			...
			<%@ include file="./sidebar.jsp" %>
		        <main>
		            ...
		            <div style="font-size: 20px; font-weight: bold; text-align: center;">
					    공연 목록 (공연 종료)
					    <br><input type="button" class="btn btn-default" value="진행중인 공연" onclick="window.location.href='./list'" style="float: right;">
					</div><br><br>
		                ...
		                <table class="table table-hover">
		                    <thead>
		                        <tr>
		                            ...
		                            <th style='text-align:left; width: 15%'>제목</th>
		                    ...
		                    <tbody>
		                        <c:forEach var="show" items="${ulist}">
		                            <tr>
		                                ...
		                                <td style="width: 15%">${show.title}</td>
		                                <td>${show.genre}</td>
		                                <td>${show.h_name}</td>

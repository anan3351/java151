...
<body>
    ...
    <div class="main-container">
        ...
        <main>
            ...
            <form name="rolefrm" id="rolefrm" method="post" action="/seller/detail/${scDto.castingId}/roleUpdate" onsubmit="return roleCheck();">
                    ...
                    <table class="table table-hover" style="width:100%">
                        <tbody style="text-align: left;">
                                        ...
                                        <c:forEach items="${roleList}" var="role">
                                            <label class="role-choice" style="display: inline-block; width: 100px; height: 30px; vertical-align: middle;">
                                                <input type="radio" name="casting" value="${role}" class="form-control role-radio style="width: 10px; height: 10px; margin-right: 5px;""
                                                    <c:if test="${role eq scDto.casting}">
                                                        checked
                                                    </c:if>>
                                                ${role}
                                            </label>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="actorId" class="form-control" value="${scDto.actorId}" readonly></td>

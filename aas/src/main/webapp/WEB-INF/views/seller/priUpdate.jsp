...
<body>
    ...
    <div class="main-container">
        ...
        <main>
			...
			<form name="prifrm" id="prifrm" method="post" action="priUpdate" onsubmit="return priceCheck();">
                    ...
                    <table class="table table-hover" style="width:100%">
                    	<tbody style="text-align: left;">
                        	<tr>
                                ...
                                <td><input type="text" name="seat_level" value="${data.seat_level}" class="form-control" size=37 placeholder="ex) R석"></td>
							</tr>
                            <tr>
                            ...
                            <tr>
	                            <td>주말차등가</td>
	                            <td><input type="number" name="add_p" value="${data.add_p}" class="form-control" placeholder="차등가가 없다면 공란으로 제출"></td>
                            </tr>
						</tbody>
					</table>
				</div><hr>
